...
## Možna nadgradnja vaje
Ko študent uspešno zaključi osnovno vajo, lahko sledi nadgradnja:
- dodajanje obrazca,
- dodajanje API klica,
- uporaba environment variables,
- povezava s Supabase,
- ponovni deploy po spremembi aplikacije.

---

## Kratek povzetek
Pri tej vaji študent izdela preprosto spletno aplikacijo, jo shrani v GitHub repozitorij in objavi na Vercel. Cilj vaje ni kompleksna aplikacija, ampak razumevanje osnovnega postopka objave sodobne spletne rešitve v produkcijsko okolje.
